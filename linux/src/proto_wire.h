...
//
// We intentionally avoid linking google::protobuf in the Linux helper:
//   - libprotobuf ABI varies between distros (Debian 13 ships 3.21, Fedora
//     41 ships 5.27); pinning a version would lock us out of common
//     systems or force vendoring.
...
//
// This file is copied verbatim from windows/src/proto_wire.h — keep them in
// sync if the schema gains new wire-types.
//
